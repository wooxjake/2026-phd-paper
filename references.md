...
상세 문헌 정보는 `references/entries/`에 분리해 보관한다. 작업 메모는 `references/notes.md`를 참조한다.

## 문헌 색인

1. **Orczyk et al. (2025)** — `candidate` - [상세](references/entries/01-orczyk-et-al-2025.md)

- The Effect of Sitting Posture on the Incidence and Severity of Low Back Pain in Adult Population – Survey Study
- 2026-08-12 문단 1 개정 시 본문에서 제외됨. N=261 비확률 표본의 자가보고 단면조사이므로 메타분석 근거로 대체하였다.

---

2. **Kim et al. (2024)** — `cited` - [상세](references/entries/02-kim-et-al-2024.md)
...
3. **Makhsous et al. (2009)** — `cited` - [상세](references/entries/03-makhsous-et-al-2009.md)
...
4. **Wong et al. (2018)** — `cited` - [상세](references/entries/04-wong-et-al-2018.md)

- Do Different Sitting Postures Affect Spinal Biomechanics of Asymptomatic Individuals?

---

5. **Chen & Zhang (2025)** — `candidate` - [상세](references/entries/05-chen-zhang-2025.md)

- Postural Variability in Sitting: Comparing Comfortable, Habitual, and Correct Strategies Across Chairs

---

6. **Kett, Milani, & Sichting (2021)** — `cited` - [상세](references/entries/06-kett-milani-sichting-2021.md)
...
7. **Lopez et al. (2024)** — `candidate` - [상세](references/entries/07-lopez-et-al-2024.md)
...
9. **O'Sullivan et al. (2012)** — `candidate` - [상세](references/entries/09-o-sullivan-et-al-2012.md)

- Can We Reduce the Effort of Maintaining a Neutral Sitting Posture? A Pilot Study

---

10. **Jung et al. (2021)** — `cited` - [상세](references/entries/10-jung-et-al-2021.md)
...
11. **Areeudomwong et al. (2012)** — `candidate` - [상세](references/entries/11-areeudomwong-et-al-2012.md)

- Effects of Handicraft Sitting Postures on Lower Trunk Muscle Fatigue

---

12. **Waongenngarm et al. (2015a)** — `candidate` - [상세](references/entries/12-waongenngarm-et-al-2015a.md)

- Perceived Body Discomfort and Trunk Muscle Activity in Three Prolonged Sitting Postures

---

13. **Waongenngarm et al. (2015b)** — `cited` - [상세](references/entries/13-waongenngarm-et-al-2015b.md)
...
14. **Amiri et al. (2025)** — `cited` - [상세](references/entries/14-amiri-et-al-2025.md)

- On the Role of Core Exercises in Alleviating Muscular Fatigue Induced by Prolonged Sitting: A Scoping Review

---

15. **Tanthuwapathom et al. (2025)** — `candidate` - [상세](references/entries/15-tanthuwapathom-et-al-2025.md)
...
- 방법론적 참고 — IMU 측정 타당성 근거용.

---

16. **Koca & Koca (2025)** — `candidate` - [상세](references/entries/16-koca-koca-2025.md)

- Anatomy-Based Assessment of Spinal Posture Using IMU Sensors and Machine Learning
- 방법론적 참고 — IMU+ML 파이프라인 선례.

---

17. **Harrison et al. (1999)** — `cited` - [상세](references/entries/17-harrison-et-al-1999.md)

- Sitting Biomechanics Part I: Review of the Literature
- 배경·고전 리뷰. Lopez et al. (2024)의 자체 인용문헌이기도 하다.

---

18. **Si et al. (2025)** — `cited` - [상세](references/entries/18-si-et-al-2025.md)
...
19. **Saiklang et al. (2022)** — `candidate` - [상세](references/entries/19-saiklang-et-al-2022.md)
...
- 방법론적으로 15분~1시간 설계와 가장 근접(41분 프로토콜).
...
21. **Lopez-Solis et al. (2025)** — `candidate` - [상세](references/entries/21-lopez-solis-et-al-2025.md)

- CrossFit vs. Sedentary Lifestyle: Unveiling the Effects on Strength, Balance and Quality of Life
- 운동군의 최소 훈련 기간 및 빈도 분류 근거.

---

22. **World Health Organization (2020)** — `cited` - [상세](references/entries/22-world-health-organization-2020.md)

- WHO Guidelines on Physical Activity and Sedentary Behaviour
- 서론 4절 「용어의 정의」에서 좌식행동·좌식시간의 정의 근거로 인용. 성인 근력강화 활동 기준은 운동군 분류의 보조 근거로 검토 중.

---

23. **Jia & Nussbaum (2018)** — `cited` - [상세](references/entries/23-jia-nussbaum-2018.md)
...
24. **GBD 2021 Low Back Pain Collaborators (2023)** — `cited` - [상세](references/entries/24-gbd-2021-low-back-pain-collaborators-2023.md)
...
26. **Roffey et al. (2010)** — `cited` - [상세](references/entries/26-roffey-et-al-2010.md)
...
28. **Baradaran Mahdavi et al. (2021)** — `cited` - [상세](references/entries/28-baradaran-mahdavi-et-al-2021.md)

- Association between Sedentary Behavior and Low Back Pain: A Systematic Review and Meta-Analysis

---

29. **Claus et al. (2016)** — `cited` - [상세](references/entries/29-claus-et-al-2016.md)
...
30. **질병관리청 (2025)** — `cited` - [상세](references/entries/30-2025.md)

- Korea Health Statistics 2024: Korea National Health and Nutrition Examination Survey (KNHANES IX-3)
- 2026-08-13 `introduce.md`의 앉아 있는 시간 현황 문단에서 국내 좌식 노출 규모와 지표 정의의 근거로 인용.

---

31. **Smith et al. (2015)** — `cited` - [상세](references/entries/31-smith-et-al-2015.md)
...
- 서론 문단 1 「앉아 있는 시간의 규모와 구성」.

---

32. **Clemes, O'Connell, & Edwardson (2014)** — `candidate` - [상세](references/entries/32-clemes-et-al-2014.md)

- Office Workers' Objectively Measured Sedentary Behavior and Physical Activity During and Outside Working Hours
- 2026-08-13 서론 문단 1에서 **인용 제외.** Kett et al. (2021)의 원출처인 35번(Clemes, Patel, Mahon, & Griffiths, 2014)을 확보하여 대체하였고, 근무시간 좌식 비율은 33번 Parry & Straker (2013)이 담당한다.
- 35번과 제1저자·연도가 같은 별개 논문이다. 다시 인용할 경우 APA 7에 따라 공저자를 밝혀 구분한다.

---

33. **Parry & Straker (2013)** — `cited` - [상세](references/entries/33-parry-straker-2013.md)

- The contribution of office work to sedentary behaviour associated risk
- 서론 문단 1 「좌식 시간의 규모와 구성」의 근무시간 좌식 비율(81.8%).

---

34. **Healy et al. (2011)** — `cited` - [상세](references/entries/34-healy-et-al-2011.md)

- Sedentary time and cardio-metabolic biomarkers in US adults: NHANES 2003-06
- 서론 문단 1 「좌식 시간의 규모와 구성」의 서구 일일 좌식시간 **하한 8.44시간**. Kett et al. (2021) 재인용의 원출처.

---

35. **Clemes, Patel, Mahon, & Griffiths (2014)** — `cited` - [상세](references/entries/35-clemes-patel-mahon-griffiths-2014.md)

- Sitting time and step counts in office workers
- 서론 문단 1 「좌식 시간의 규모와 구성」에서 **직장 좌식이 하루 총 좌식시간의 63%**를 차지한다는 근거. Kett et al. (2021) 재인용의 원출처.
- 좌식시간은 기기가 아니라 자가기입 일지로 측정되었다. 32번과 제1저자·연도가 같은 별개 논문이다.

---

36. **van der Velde et al. (2017)** — `cited` - [상세](references/entries/36-van-der-velde-et-al-2017.md)
...
- [참고문헌 작업 메모](references/notes.md)
- 미확보 원출처, 보관 폴더 대조, 등록 대기 자료는 작업 메모에서 관리한다.

## 관리 원칙

- 본문 인용 여부는 이 색인의 `cited` 또는 `candidate` 상태를 기준으로 판단한다.
- 문헌의 서지·방법·결과·활용 범위는 해당 상세 파일에서 확인한다.
- 문헌을 추가하거나 갱신할 때에는 색인과 상세 파일을 함께 갱신한다.
